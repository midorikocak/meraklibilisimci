...
<figcaption class="wp-caption-text">Doğrulama</figcaption>
...
<figcaption class="wp-caption-text">Kodu sürekli hatalara karşı kontrol edeceğiz.</figcaption>
...
<figcaption class="wp-caption-text">İstisna yani Excetion</figcaption>
...
<figcaption class="wp-caption-text">Sözlük programımızı yazmaya devam ediyoruz.</figcaption>
...
<figcaption class="wp-caption-text">Yakalanmış istisna durumu</figcaption>
